...
import {
    CommentDataResponseData,
    CommentLikesIdResponseData,
    SaveOrDeleteResponseData,
    VisComment,
} from "./type";
...
export const CommentSaveRequest = (comment: CommentData) => {
    ...
    return request.post<any, SaveOrDeleteResponseData>(API.COMMENT_SAVE, {
        uid,
        forumId,
        parentId,
        content,
...
export const CommentDeleteRequest = (
    ...
    return request.post<any, SaveOrDeleteResponseData>(API.COMMENT_DELETE, {
        id,
        parentId,
    });
};
...
// 点赞
export const addCommentLikesRequest = (
    uid: string | number,
    commentId: string | number
) => {
    return request.post<any, SaveOrDeleteResponseData>(API.COMMENTLIKE_ADD, {
        uid,
        commentId,
    });
};
...
// 取消电站
export const removeCommentLikeRequest = (
    uid: string | number,
    commentId: string | number
) => {
    return request.post<any, SaveOrDeleteResponseData>(API.COMMENTLIKE_REMOVE, {
        uid,
        commentId,
    });
};
